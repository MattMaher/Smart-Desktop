...
! function(t) {
    t.fn.openWeather = function(e) {
        ...
        null != r.city ? o += "&q=" + r.city : null != r.lat && null != r.lng && (o += "&lat=" + r.lat + "&lon=" + r.lng), null != r.key && (o += "&appid=" + r.key), t.ajax({
            ...
            success: function(e) {
                if (e) {
                    if ("f" == r.units ? (l = Math.round(1.8 * (e.main.temp - 273.15) + 32) + "°F", s = Math.round(1.8 * (e.main.temp_min - 273.15) + 32) + "°F", u = Math.round(1.8 * (e.main.temp_max - 273.15) + 32) + "°F") : (l = Math.round(e.main.temp - 273.15) + "°C", s = Math.round(e.main.temp_min - 273.15) + "°C", u = Math.round(e.main.temp_max - 273.15) + "°C"), a = {
                        ...
                        } else n = `http://openweathermap.org/img/w/${e.weather[0].icon}.png`;
